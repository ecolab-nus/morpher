...
int8_t data[744];
int8_t kernel[192];
int16_t dwconv2[564];// tvm target: c -keys=cpu 
...
TVM_DLL int32_t conv_main(void* args, int32_t* arg_type_ids, int32_t num_args, void* out_ret_value, int32_t* out_ret_tcode, void* resource_handle) {
  ...
  for (int32_t c_outer = 0; c_outer < 4; ++c_outer) {
    ...
    for (int32_t c_inner_oh_fused_ow_fused_m_fused_rh_fused_rw_outer_fused = 0; c_inner_oh_fused_ow_fused_m_fused_rh_fused_rw_outer_fused < 282; ++c_inner_oh_fused_ow_fused_m_fused_rh_fused_rw_outer_fused) {
      ...
      int32_t cse_var_2 = ((cse_var_4 + cse_var_7) + cse_var_6)*2;
      int32_t cse_var_1 = (((cse_var_5 + cse_var_4) + cse_var_7) + cse_var_6);
      ((int16_t*)dwconv2)[cse_var_2] = (((int16_t*)dwconv2)[cse_var_2] + (((int8_t*)data)[cse_var_1] * ((int8_t*)kernel)[cse_var_3]));
      ((int16_t*)dwconv2)[cse_var_2] = (((int16_t*)dwconv2)[cse_var_2] + (((int8_t*)data)[(cse_var_1 + 12)] * ((int8_t*)kernel)[(cse_var_3 + 12)]));
      ((int16_t*)dwconv2)[cse_var_2] = (((int16_t*)dwconv2)[cse_var_2] + (((int8_t*)data)[(cse_var_1 + 24)] * ((int8_t*)kernel)[(cse_var_3 + 24)]));
      ((int16_t*)dwconv2)[cse_var_2] = (((int16_t*)dwconv2)[cse_var_2] + (((int8_t*)data)[(cse_var_1 + 36)] * ((int8_t*)kernel)[(cse_var_3 + 36)]));
      ((int16_t*)dwconv2)[cse_var_2] = (((int16_t*)dwconv2)[cse_var_2] + (((int8_t*)data)[(cse_var_1 + 48)] * ((int8_t*)kernel)[(cse_var_3 + 48)]));
      ((int16_t*)dwconv2)[cse_var_2] = (((int16_t*)dwconv2)[cse_var_2] + (((int8_t*)data)[(cse_var_1 + 60)] * ((int8_t*)kernel)[(cse_var_3 + 60)]));
      ((int16_t*)dwconv2)[cse_var_2] = (((int16_t*)dwconv2)[cse_var_2] + (((int8_t*)data)[(cse_var_1 + 72)] * ((int8_t*)kernel)[(cse_var_3 + 72)]));
      ((int16_t*)dwconv2)[cse_var_2] = (((int16_t*)dwconv2)[cse_var_2] + (((int8_t*)data)[(cse_var_1 + 84)] * ((int8_t*)kernel)[(cse_var_3 + 84)]));
      if (div_94_j +1 == 94) {
        div_94_i++;
        div_94_j= 0;
      } else {
