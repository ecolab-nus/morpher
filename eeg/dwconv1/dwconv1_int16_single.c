...
int8_t data[5640];
int8_t kernel[60];
int16_t dwconv1[564];// tvm target: c -keys=cpu 
...
TVM_DLL int32_t conv_main(void* args, int32_t* arg_type_ids, int32_t num_args, void* out_ret_value, int32_t* out_ret_tcode, void* resource_handle) {
  ...
  for (int32_t ow_outer = 0; ow_outer < 1; ++ow_outer) {
    int32_t mod_12 = 0;
    for (int32_t ow_inner_c_fused_m_fused = 0; ow_inner_c_fused_m_fused < 564; ++ow_inner_c_fused_m_fused) {
      ...
      ((int16_t*)dwconv1)[cse_var_2] = (int8_t)0;
      int16_t tmp = (((int8_t*)data)[cse_var_1] * ((int8_t*)kernel)[cse_var_3]);
      ((int16_t*)dwconv1)[cse_var_2] = (((int16_t*)dwconv1)[cse_var_2] + tmp);
      tmp = (((int8_t*)data)[cse_var_1] * ((int8_t*)kernel)[cse_var_3 + 12]);
      ((int16_t*)dwconv1)[cse_var_2] = (((int16_t*)dwconv1)[cse_var_2] + tmp);
      tmp = (((int8_t*)data)[cse_var_1] * ((int8_t*)kernel)[cse_var_3 + 24]);
      ((int16_t*)dwconv1)[cse_var_2] = (((int16_t*)dwconv1)[cse_var_2] + tmp);
      tmp = (((int8_t*)data)[cse_var_1] * ((int8_t*)kernel)[cse_var_3 + 36]);
      ((int16_t*)dwconv1)[cse_var_2] = (((int16_t*)dwconv1)[cse_var_2] + tmp);
      tmp = (((int8_t*)data)[cse_var_1] * ((int8_t*)kernel)[cse_var_3 + 48]);
      ((int16_t*)dwconv1)[cse_var_2] = (((int16_t*)dwconv1)[cse_var_2] + tmp);
      // printf("dwconv1[%d] = %d\n", cse_var_2, (int16_t*)dwconv1[cse_var_2]);
      if (mod_12 + 1 == 12) {
        mod_12 = 0;
      } else {
        mod_12++;
...
int main() {
    ...
    // write out tensor
    if (write_int16_data("dwconv1_output.txt", dwconv1, 564) != 0) {
