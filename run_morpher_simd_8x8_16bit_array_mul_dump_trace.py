...
#   os.system('python ../../../update_mem_alloc.py ../../../json_arch/hycube_simd_updatemem.json array_add_mem_alloc.txt 8192 2 hycube_simd_mem.json')
#   os.system('python ../../../update_mem_alloc.py ../../../json_arch/hycube_simd_updatemem_RC.json array_add_mem_alloc.txt 8192 2 hycube_simd_mem_RC.json')
#   print('\nupdate memory allocation done!\n')

#   II_right = 0
  II_left = 4
#   os.system('../../../build/src/cgra_xml_mapper -d array_add_simd.xml -x 4 -y 4 -j hycube_simd_mem.json -t HyCUBE_4REG')
#   for file in os.listdir("./"):
#     if file.endswith(".bin"):
#         II_left=int(file.split('II=')[-1].split(' ')[0].split('_MTP')[0].split(' ')[0])+1
#     os.system('mv *.bin binary/left.bin')
#   os.system('../../../build/src/cgra_xml_mapper -d array_add_simd.xml -x 4 -y 4 -j hycube_simd_mem_RC.json -t HyCUBE_4REG')
#   for file in os.listdir("./"):
#     if file.endswith(".bin"):
